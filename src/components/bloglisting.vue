  ...
  <div id="root">
    <div class="content-wrapper max-w-screen-2xl text-base mx-auto px-8  ">
     ...
     <main class=" lg:px-36">
        ...
        <div class="w-full h-[450px] bg-no-repeat bg-cover bg-[url('img/background')] bg-center rounded-xl my-10"></div>
        <div class="flex justify-between space-x-4">
            <div class="block my-4 border rounded-lg border-slate-200" style="height: 488px; width: 392px;">
                ...
                <div class="relative mx-4 my-4">
                    <div class="flex justify-between me-12">
                        <img src="/src/img/background.png" alt="" class="rounded-full" style="width: 36px; height:36px">
                        <span class="my-auto text-slate-400">Ambatucam</span>
                        <span class="my-auto text-slate-400">11/11/2024</span>
                    </div>
                </div>
            </div>
        </div>
...
//       buttonTitle: 'Bam vao nut de thay doi loi chao'
//     };
//   },
//   methods: {
//     changeTitle() {
//       this.greeting = 'Hello, World!';
//       this.buttonTitle = 'Da thay doi loi chao';
//     }
//   }
// }
</script> -->