...
<template>
    <div class="container w-8/12 mx-auto">
					<button
						class="w-auto px-3 py-1 my-3 text-white bg-blue-600 rounded-md"
					>
						Technology
					</button>
					...
					<div class="flex">
						<div class="flex my-5 float-start">
							...
							/>
							<span class="my-auto text-slate-400"
								>Ambatucam</span
							>
						</div>
						<span class="my-auto text-slate-400 mx-11"
							>11/11/2024</span
						>
					</div>
					<img
...
<br>
            Vitae sapien pellentesque habitant morbi tristique. Luctus venenatis lectus magna fringilla.
             Nec ullamcorper sit amet risus nullam eget felis. Tincidunt arcu non sodales neque sodales ut etiam sit amet.
					</p>
          <div class="w-full  h-20 mb-10 bg-gray-100 rounded-lg shadow-md">
            <div class="text-xl sm:text-lg font-serif mx-10 sm:mx-3 pt-3 sm:pt-1">"Traveling can expose you to new environments and potential health risks, so it's crucial to take precautions to stay safe and healthy. "</div>
          ...
          <img
						...
						class="w-full  h-full rounded-md"
					/>
          <div class=" pt-3 px-4 lg:pt-10 lg:px-32 bg-opacity-95 h-32 lg:h-56">
        ...
        <p class="my-6">
          ...
          <p class="my-6">
						<b>Immerse Yourself in the Local Culture
            </b>
						<br><br>
